...
//
//	public class WMXEndToEndValidation extends TestBase {
//
...
//		public List<Map<String, String>> vfData;
...
//		int count=0,result;
//		String verificationTableName = "VERIFICATION";
//		String testTableName= "CMX_INSERT";
//		
...
//			omxData = new OmxData();
//			testData= new TestData();
//			dbt.createConnection(testData.serverName_TESTDB,testData.port_TESTDB,testData.database_TESTDB,testData.userid_TESTDB,testData.password_TESTDB);
...
//		public void cmxInsertOrderDB(String testId,String client_Id,String siteId,String insertQuery,String Desc) throws IOException {
//			try {
//				if (insertDataRecordCMXAndVerify(testId,insertQuery,client_Id)) {
...
//		
//		@Test(dataProvider = "oracleDb-provider")
//		public void cmxInsertDB(String testId,String client_Id,String siteId,String insertQuery,String Desc) throws IOException {
//			try {
//				if (insertDataRecordToCMX(testId,insertQuery,client_Id)) {
//					test.log(Status.PASS, "Successfully Inserted Record into CMXDATA.X_TRANSMISSION");
//				} else {
//					reportStatusFail("Error in Inserting  Record into CMXDATA.X_TRANSMISSION");
//				}
...
//
//		@Test(dataProvider = "oracleDb-provider")
//		public void omxVefiryDB(String testId,String client_Id,String siteId,String insertQuery,String Desc) throws IOException {
//			try {
//				if (verifyDataRecordOMX(testId,insertQuery,client_Id)) {
//					test.log(Status.PASS, "Successfully Inserted Record into CMXDATA.X_TRANSMISSION");
//				} else {
//					reportStatusFail("Error in Inserting  Record into CMXDATA.X_TRANSMISSION");
//				}
...
//				List<Map<String, String>> dbData = dbt.select_scriptAndQuery(wmxScript, wmxStatusQuery);
//				status = dbData.get(0).get("STATUS");
...
//		 * @return
//		 */
//		public boolean insertDataRecordCMXAndVerify(String testId,String query,String client_id) {
...
//
//				String sqlInsertQuery = util.setCMXInsertQuery(query);
//				String insertedRecordID = dbt.executeInsertGetGeneratedKeys(sqlInsertQuery);
//				System.out.println("Inserted Record ID: " + insertedRecordID);
//				OracleDB db1 = new OracleDB(testData.serverName_TESTDB,testData.port_TESTDB,testData.database_TESTDB,testData.userid_TESTDB,testData.password_TESTDB,true);
//				String sqlSelectQueryValidation = "select * from "+verificationTableName+" WHERE CLIENT_ID='"+client_id+"'";
//				System.out.println(sqlSelectQueryValidation);
//				List<Map<String, String>> dbData = dbt.selectVerfSQL(sqlSelectQueryValidation);
...
//				{
//					 
//					String sqlSelectQuery = util.setCMXSelectQuery(dbData.get(row).get("QUERY"));
//					ResultSet rs=dbt.executeSelectAndFetchVerificationResultset(sqlSelectQuery);
//					rs.next();
//					System.out.println(dbData.get(row).get("TEST_ID")+"="+rs.getInt(1));
//					
//					
//				}
//			
...
//		}
//		
//		public boolean insertDataRecordToCMX(String testId,String query,String client_id) {
//			boolean insertionSuccess = false;
//			
//			try {
//				OracleDB db = new OracleDB(CmxData.serverName_CMXDB, CmxData.port_CMXDB, CmxData.database_CMXDB,
...
//
//		}
//		public boolean verifyDataRecordOMX(String testId,String query,String client_id) {
//			boolean insertionSuccess = false;
//			
//			try {
...
//				System.out.println(dbData.size());
//				OracleDB db2 = new OracleDB(omxData.serverName_QA_OMXDB, omxData.port_QA_OMXDB, omxData.database_QA_OMXDB,omxData.userid_QA_OMXDB, omxData.password_QA_OMXDB,true);
//				Map<String, String> verifyResultMap=new HashMap<String, String>();
//				for (int row = 0; row< dbData.size(); row++) 
//				{
//					 
//					String sqlSelectQuery = util.setCMXSelectQuery(dbData.get(row).get("QUERY"));
...
//					System.out.println(dbData.get(row).get("TEST_ID")+"="+rs.getInt(1));
//					if(rs.getInt(1)==1)
//					verifyResultMap.put(dbData.get(row).get("TEST_ID"), "PASS");
//					else
//					verifyResultMap.put(dbData.get(row).get("TEST_ID"), "FAIL");	
//					
//				}
//				OracleDB db3 = new OracleDB(testData.serverName_TESTDB,testData.port_TESTDB,testData.database_TESTDB,testData.userid_TESTDB,testData.password_TESTDB,true);
//				 
//				String updateCleanQuery = "UPDATE "+verificationTableName+" set STATUS = ? where TEST_ID= ?";
//				pstmt=dbt.conn.prepareStatement(updateCleanQuery);
//				int statuscount=dbt.updateStatusInOMX(updateCleanQuery,verifyResultMap);
...
//		{
//			String sqlSelectQueryValidation = "select * from  " + testTableName+"";
//			
//			String myData[][] = null;
//			try
//			{
...
//				myData = new String[(dbData.size())][5];
//
//				//populate data structure
//				for (int row = 0; row< dbData.size(); row++) 
//				{
//					myData[row][0] = dbData.get(row).get("TEST_ID");
//					myData[row][1] = dbData.get(row).get("CLIENT_ID");
//					myData[row][2] = dbData.get(row).get("SITE_ID");
//					myData[row][3] = dbData.get(row).get("INSERT_Q");
//					myData[row][4] = dbData.get(row).get("DESCR");
//					
//				}
//			}
//			catch (Exception e) 

...
public class LorealASN_DB extends TestBase {
...
//
	...
	public void wmxTestCreateReceipt() {
		...
		receiptPage.setQty(getAsnExpectedQty());	
...
//			if(getInvQtyBeforePutaway()==true) {
...
//			Utils.sleep(120000);
			...
			File file = new File("C:\\Users\\hsawant\\eclipse-workspace\\sc-qa-wmx\\src\\main\\resources\\LorealASN3_ReceiptConfirmationPaylaod.txt");
			...
			String ReceiptConfirmationPaylaod="C:\\Users\\hsawant\\eclipse-workspace\\sc-qa-wmx\\src\\main\\resources\\LorealASN3_ReceiptConfirmationPaylaod.txt";
			
			String maskPath="C:\\Users\\hsawant\\eclipse-workspace\\sc-qa-wmx\\src\\main\\resources\\MaskForLorealASN3.txt";
			
			String ReceiptConfirmationGoldPaylaod="C:\\Users\\hsawant\\eclipse-workspace\\sc-qa-wmx\\src\\main\\resources\\LorealASN3_ReceiptConfirmationGoldPayload.txt";
...
//	
	...
	public boolean insertASNDataRecordCMX() {
		...
		try {
			...
			String sqlInsertQuery = util.setAsnQuery();
...
//			String wmxInvIdQuery= "Select INVENTORYID FROM WX_INVENTORY WHERE LPN='" + getLPN() + "' AND LOC= ' "+ "QARE03 "+"' ";
			
//			String wmxInvIdQuery= "Select INVENTORYID FROM WX_INVENTORY WHERE LPN='" + "2220195209" + "' AND LOC= ' "+ "QARE03 "+"' ";
			...
			List<Map<String, String>> dbData=db.select_scriptAndQuery(wmxScript, wmxInvIdQuery);
			 ...
			 invid=dbData.get(1).get("INVENTORYID");
			 
			 if(dbData.get(1).get("LOC").equalsIgnoreCase("QARE03")) {
				 
				 
			 }else {
				 
				 reportStatusFail("Expected record not created");
			 }
...
//			String wmxScript = "BEGIN WMXVPD.COREUTL_VPD_SECURITY.SET_SITEID (PV_SITEID => 'ONT004'); COMMIT; END; ";
//			
//			String wmxTaskRecordStatusQuery= "Select * FROM WX_TASK WHERE DOCKEY='" + getDocKey() + "'";
...
//     public String getInvQtyBeforePutaway() {
// 		String qty="";
// 		
// 		try {
// 			
...
// 			String wmxScript = "BEGIN WMXVPD.COREUTL_VPD_SECURITY.SET_SITEID (PV_SITEID => 'ONT004'); COMMIT; END; ";
// 			
// 			String wmxInvQtyBeforeQuery= "Select QTY FROM WX_INVENTORY WHERE INVENTORYID='" + "210956" + "'";
// 			List<Map<String, String>> dbData=db.select_scriptAndQuery(wmxScript, wmxInvQtyBeforeQuery);
// 			qty=dbData.get(0).get("QTY");
// 			
//// 			210956
//// 			201779
// 			
...
// 	}
     ...
     public boolean getInvQtyBeforePutaway() {
...
// 			String LPN=getLPN();
 			...
 			String wmxInvQtyBeforeQuery= "Select QTY FROM WX_INVENTORY WHERE INVENTORYID='" + getInvId() + "'";
 			List<Map<String, String>> dbData=db.select_scriptAndQuery(wmxScript, wmxInvQtyBeforeQuery);
 			String qty=dbData.get(0).get("QTY");
 			int qtyAfterPutaway=Integer.parseInt(qty);
 			if(qtyAfterPutaway==10) {
...
//
//
// 			String wmxLPNQuery= "Select RECEIPTKEY FROM WX_RECEIPTDTL WHERE LPN='" + getLPN() + "'";
// 			List<Map<String, String>> dbData=db.select_scriptAndQuery(wmxScript, wmxLPNQuery);
